...
Use this [LINK](https://console.redhat.com/openshift/install/pull-secret) to download your RedHat Pull Secret.
...
![redhat_login](/images/docimages/redhat_login.png)

Then click on "Register for a Red Hat Account".

![redhat_register](/images/docimages/redhat_register.png)
...
![openshift_try_it](/images/docimages/openshift_try_it.png)
...
![openshift_start_trial](/images/docimages/openshift_start_trial.png)
...
Key Pair generation instructions [here](02-preparation.html#create-aws-keypair)

RedHat Pull Secret instructions [here](02-preparation.html#obtain-redhat-pull-secret)
