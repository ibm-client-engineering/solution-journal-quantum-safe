...
![QSRAP-config1](/images/QSRAP-config1.png)
...
![QSRAP-config2](/images/QSRAP-config2.png)
...
![QSRAP-config3](/images/QSRAP-config3.png)

Open the Developer Tools

![QSRAP-config4](/images/QSRAP-config4.png)

Click the `Security` panel

![QSRAP-config5](/images/QSRAP-config5.png)
